...
class Card extends React.PureComponent<StateProps & DispatchProps & RouteComponentProps & WithStyles<typeof styles>> {
...
export { WrappedWithStylesComponent as Board };
